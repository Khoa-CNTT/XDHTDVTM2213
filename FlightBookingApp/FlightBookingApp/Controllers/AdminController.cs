    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                ...
                {
                    // Đọc thống kê từ bảng StatisticsSummary
                    var stats = await _context.StatisticsSummary.FirstOrDefaultAsync();
                    if (stats == null)
                    {
                        stats = new StatisticsSummary
                        {
                            CompletedFlights = 0,
                            ActiveFlights = 0,
                            CanceledFlights = 0,
                    ...
                    viewModel = new AdminIndexViewModel
                    {
                        ...
                        CanceledFlights = stats.CanceledFlights,
                        TotalRevenue = stats.TotalRevenue,
                        TotalVisits = stats.TotalVisits,
                        VisitsToday = stats.VisitsToday,
                        TotalTicketsThisMonth = stats.TotalTickets,
