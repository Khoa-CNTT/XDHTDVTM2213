        ...
        public IActionResult SearchFlightsAjax(string tripType, string fromIata, string toIata, string departureDate, string returnDate, int adultCount, int childCount)
        {
            try
            {
                ...
                return Json(new
                {
                    ...
                    departureAirport = new { city = departureAirport.City, iataCode = departureAirport.IataCode },
                    destinationAirport = new { city = destinationAirport.City, iataCode = destinationAirport.IataCode },
